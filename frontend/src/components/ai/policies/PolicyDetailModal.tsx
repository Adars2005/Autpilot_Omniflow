...
// ============================================================================
// Component — CSS transitions only, no framer-motion
// ============================================================================
...
export function PolicyDetailModal({
  ...
  if (!mounted || !isOpen || !policy) return null
  ...
  const modalContent = (
    ...
    >
      <div
        className="relative w-full max-w-2xl max-h-[85vh] bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col animate-in zoom-in-95 slide-in-from-bottom-2 duration-200"
      ...
      >
        ...
        <div className="flex items-start justify-between px-6 py-5 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
          ...
          <Button variant="ghost" size="icon" onClick={onClose} className="flex-shrink-0 hover:rotate-90 transition-transform duration-200">
                  ...
                  <div className="space-y-2">
                    {policy.dsl.conditions.map((cond, idx) => {
                      ...
                      return (
                        <div
                          key={idx}
                          className="flex items-center gap-3 p-2.5 bg-white rounded-lg border border-blue-100 hover:border-blue-200 hover:shadow-sm transition-all duration-150"
                        >
